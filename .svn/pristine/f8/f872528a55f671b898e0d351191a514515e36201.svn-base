...
public class AddProductPopup extends Popup {
	...
	private HBox setUpButtons() {
		...
		addButton.setOnAction(ManageProductsUIControl.INSTANCE.getAddProductHandler(this));
		
		cancelButton.setOnAction(ManageProductsUIControl.INSTANCE.getAddProductCloseHandler(this));
