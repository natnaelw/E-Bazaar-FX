...
public interface CustomerSubsystem {
	 ...
	 * an address in ship/bill window. Requires a trip to the database.
	 */
	 ...
	 * CustomerSubsystemFacade will be out of date; this method should cause
	 * order data to be reloaded
	 */
	...
	void checkCreditCard() throws BusinessException;
