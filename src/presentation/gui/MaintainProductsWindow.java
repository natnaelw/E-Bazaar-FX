...
public class MaintainProductsWindow extends Stage implements MessageableWindow {
	...
	private void setUpTable() {
        ...
        quantityCol.setOnEditCommit(ManageProductsUIControl.INSTANCE.getQuantityColEditHandler());
        
        
        nameCol= TableUtil.makeEditableTableColumn(table, new ProductPres(), "Name", "nameProperty", 80);         
        nameCol.setOnEditCommit(ManageProductsUIControl.INSTANCE.getNameColEditHandler());
        
        
    	unitPriceCol= TableUtil.makeEditableTableColumn(table, new ProductPres(), "Unit Price", "unitPriceProperty", 80);  
    	unitPriceCol.setOnEditCommit(ManageProductsUIControl.INSTANCE.getUnitPriceColEditHandler());
        
    	mfgDateCol= TableUtil.makeEditableTableColumn(table, new ProductPres(), "Mfg Date", "mfgDateProperty", 80);  
    	mfgDateCol.setOnEditCommit(ManageProductsUIControl.INSTANCE.getMfgDateColColEditHandler());
	...
	private HBox setUpButtons() {
		...
		addButton.setOnAction(ManageProductsUIControl.INSTANCE.getDisplayAddProductGUIHandler());
		return btnBox;
	}
