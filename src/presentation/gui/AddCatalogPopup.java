...
public class AddCatalogPopup extends Popup {
	...
	private HBox setUpButtons() {
		...
		addButton.setOnAction(ManageProductsUIControl.INSTANCE.getAddCatalogsHandler(this));		
		cancelButton.setOnAction(ManageProductsUIControl.INSTANCE.getAddCatalogCloseHandler(this));
		return btnBox;
	}

	void setBackground(Color color) {
		topLevel.backgroundProperty().set(
				new Background(new BackgroundFill(color, CornerRadii.EMPTY,
						Insets.EMPTY)));
	}
